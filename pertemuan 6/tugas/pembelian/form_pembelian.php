...
<form method="POST" action="proses_pembelian.php">
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Produk</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="harga_beli" name="produk_id" 
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Vendor</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="harga_beli" name="vendor_id" 
        value="<?php if(isset($row['vendor_id'])) echo $row['vendor_id']; ?>" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
