						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap thumbnail pertama" src="../img/28.jpeg" />
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Kedua" src="../img/29.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Penghapus
												</h5>
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Ketiga" src="../img/30.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Kuas Gambar
												</h5>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap thumbnail pertama" src="../img/31.jpeg" height="338"/>
											<div class="card-block">
												<h5 class="card-title text-center">
													Cat Air
												</h5>
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Kedua" src="../img/32.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Kerayon
												</h5>
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Ketiga" src="../img/33.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Pensil Warna
												</h5>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap thumbnail pertama" src="../img/34.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Penggaris
												</h5>
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Kedua" src="../img/35.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Pensil Grafis
												</h5>
									...
									<div class="col-md-4">
										<div class="card bg-info text-white">
											<img class="card-img-top" alt="Bootstrap Thumbnail Ketiga" src="../img/36.jpeg" />
											<div class="card-block">
												<h5 class="card-title text-center">
													Jangka
												</h5>
