        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Table Customer</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Customer</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <a href="tambah_cus/tambah_cus.php?tambah" class="btn btn-success"><i class="fas fa-table me-1"></i>
                                TAMBAH TABLE</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="tambah_cus/view.php?view=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    View
                                                </a>
                                                <a href="tambah_cus/tambah_cus.php?edit=<?= $tabel['id']?>" type="button" class="btn btn-success btn-sm"> 
                                                <i class="fa fa-paint-brush" aria-hidden="true"></i>
                                                Edit</a>
                                               
                                                <a href="tambah_cus/proses_cus.php?hapus=<?= $tabel['id']?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('apakah anda yakin ingin menghapus data???')">
