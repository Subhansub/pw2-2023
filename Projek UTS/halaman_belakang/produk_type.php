        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <h1 class="mt-4">Table Tipe Produk</h1>
                    ...
                    <div class="container">
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="tambah_type/tambah_type.php?tambah" class="btn btn-success"><i class="fas fa-table me-1"></i>
                                    TAMBAH TABLE</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-border table-hover py-4 text-center">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $tabel['name']?></td>
                                                <td>
                                                <a href="tambah_type/view.php?view=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    View
                                                </a>
                                                <a href="tambah_type/tambah_type.php?edit=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-paint-brush" aria-hidden="true"></i>
                                                    Edit
                                                </a>
                                                    <a href="tambah_type/proses_type.php?hapus=<?= $tabel['id']?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('apakah anda yakin ingin menghapus data???')">
