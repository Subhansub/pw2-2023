                            ...
                            <table class="table table-border table-hover">
                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $nomor ?></td>
                                            <td><?= $tabel['order_number']?></td>
                                            <td><?= $tabel['date']?></td>
                                            <td><?= $tabel['qty']?></td>
                                            <td><?= $tabel['total_price']?></td>
                                            <td><?= $tabel['customer_id']?></td>
                                            <td><?= $tabel['product_id']?></td>
                                            <td>
                                                <a href="tambah_order/view.php?view=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    View
                                                </a>
                                                <a href="tambah_order/tambah_order.php?edit=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-paint-brush" aria-hidden="true"></i>
                                                    Edit
                                                </a>
                                                <a href="tambah_order/proses_order.php?hapus=<?= $tabel['id']?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('apakah anda yakin ingin menghapus data???')">
