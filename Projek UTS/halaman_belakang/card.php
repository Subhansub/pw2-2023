        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Table Card</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Card</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <a href="tambah_card/tambah_car.php?tambah" class="btn btn-success"><i class="fas fa-table me-1"></i>
                                TAMBAH TABLE</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $tabel['code']?></td>
                                            <td><?= $tabel['name']?></td>
                                            <td><?= $tabel['discount']?></td>
                                            <td><?= $tabel['member_fee']?></td>
                                            <td>
                                                <a href="tambah_card/view.php?view=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                                    View
                                                </a>
                                                <a href="tambah_card/tambah_car.php?edit=<?= $tabel['id']?>" type=" button" class="btn btn-success btn-sm">
                                                    <i class="fa fa-paint-brush" aria-hidden="true"></i>
                                                    Edit
                                                </a>
                                                <a href="tambah_card/proses_car.php?hapus=<?= $tabel['id']?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('apakah anda yakin ingin menghapus data???')">
